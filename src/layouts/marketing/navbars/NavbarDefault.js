...
const NavbarDefault = ({ headerstyle, login }) => {
			...
			<Fragment>
				...
				>
					...
					<Dropdown.Menu
						...
						align="end"
					>
						<div className="-bottom px-3 pt-3 pb-3 d-flex justify-content-between align-items-end">
						...
						<div className="-top px-3 pt-3 pb-3">
							<Link
				...
				<Dropdown as={Nav.Item}>
					<Dropdown.Toggle
						as={Nav.Link}
						bsPrefix="dt"
						className="rounded-circle -bottom-0"
						id="dropdownUser"
					>
    ...
    <Fragment>
      <Navbar
        ...
        expand="lg"
        className={`${login ? "bg-white" : ""} navbar  p-2 d-flex ${
      ...
      >
        <Container fluid className='' >
          <Navbar.Brand as={Link} to="/">
            {/* <Image src={Logo} alt="" /> */}
            <Image src={Logo1} style={{ width: "7%" }} alt="" />
          </Navbar.Brand>
          <div
          ...
          <Navbar.Collapse id="basic-navbar-nav" className="w-100">
            <Nav className="w-100  justify-self-start mr-3 ">
            ...
            {/* Search Form */}
            {/* <Form className="mt-3 mt-lg-0 ms-lg-3 mr-3 d-flex align-items-center">
              <span className="position-absolute ps-3 mr-3 search-icon">
